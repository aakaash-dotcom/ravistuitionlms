...
export const translations = {
  ta: {
    ...
    morning: 'காலை',
    evening: 'மாலை',
    happyBirthday: 'இனிய பிறந்தநாள் நல்வாழ்த்துகள்!',
    birthdayWish: 'ரவிஸ் டியூஷன் சென்டர் சார்பாக இனிய பிறந்தநாள் மற்றும் கல்வி ஆண்டு நல்வாழ்த்துகள்!',
    notifications: 'அறிவிப்புகள்',
    markAsRead: 'அனைத்தையும் படித்ததாக குறிக்கவும்',
  ...
  en: {
    ...
    birthdayWish: "Ravi's Tuition Centre wishes you a wonderful year ahead! Learn Smart. Grow Strong.",
